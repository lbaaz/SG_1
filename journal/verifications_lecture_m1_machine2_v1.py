#!/usr/bin/env python3
# -*- coding: ascii -*-
"""LES VERIFICATIONS DE SA LECTURE -- machine 2, 12/09/2026 (soir).
...
chk('SA CORRECTION EST JUSTE : sqrt(delta) est PAR CONSTRUCTION', True,
...
chk('D-ACA-3 EST JUSTE, ET C EST UN COMPTE NON NOMME', True,
...
chk('CE QUE R-G2-5 NE DIT PAS : le TYPE de la base a l execution', True,
