...
(redaction machine 2, depot operateur, 2026-09-13) -- PROJET, VERSION 2
=======================================================================
v2 = v1 (f1e3530df9b0958c, certifiee CERTIFIABLE par machine 1, note 1bf1f044210cd2b0,
lot 00e6fa4807fea24f ; REMPLACEE, non editee) + H1, son hunk : la declaration de
detention unique ci-dessous. Aucun nombre ne change.
...
nn.1 PIECES CITEES (convention B, sha256 NFC+LF, 16 hex ; "au registre" = dans
  ...
  DETENTION UNIQUE, DECLAREE (H1) : au 13/09, UNE des vingt-trois empreintes citees
    par cet acte n'est detenue qu'au poste machine 2 et n'a pas ete transmise a
    machine 1 -- 435302fae671f4f8, le lot 'reglage mesure' (six pieces et son
    manifeste : la note, les brouillons de pre-vol a n = 18, 20 et 24, le selftest a
    n = 20, la construction du brouillon). Elle entre au registre par cet acte et y
    devient verifiable par quiconque sur clone frais ; les vingt-deux autres
    resolvent aux deux postes (rejeu machine 1 du perimetre : 8 au registre, 14 au
    poste, 1 non resolue). La reserve de machine 1 se clot par son releve apres
    depot, a sa plume.
...
-- FIN journal_delta_nn_constante_A_run_v2 --
