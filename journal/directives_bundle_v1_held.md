...
GITHUB (machine 1, 2026-08-10) -- v1, POUR ARBITRAGE ET EXECUTION
=======================================================================
...
2. PERIMETRE PROPOSE (OPTION LARGE, D-B1)
  bundle-v1/
    ...
    notes/
      note_outreach_EN_2026-07-25q.md          (note principale)
      note_companion_EN_interdegree_v2.md      (cette livraison)
...
5. GABARIT README (a rediger machine 2 ; EN ; une page max)
  - Titre, une phrase de contexte, lien vers notes/ comme point
    d'entree (ordre de lecture : note principale, puis compagne v2).
