...
*Version du fichier : 25/07-e (certification M3 fermee + E13). Même nom de
fichier à chaque livraison — en cas de doute sur la fraîcheur, vérifier cette
ligne et le sha256 imprimé à la livraison (cf. E11). Sommaire attendu : §0–§15,
ERRATA E1–E13, pré-enregistrements M2/M3.*
