...
(redaction machine 1, depot operateur, 2026-09-11) -- PROJET, VERSION 1
=======================================================================
...
nn.2 LES FAITS ACQUIS
  ...
  A-4  VOLET A : LA MOITIE GEL DE P-D1-9 TIENT, LA MOITIE EXCURSION EST
       ...
       mouvement libre, apex = s0 (3 + w2^2)/Delta a 1e-6 pres, plates ; les six
  ...
  A-6  LA PERIODE DE L'ENVELOPPE SOUS LE SEUIL A 2:1, DERIVEE, TENUE A DEUX
       ...
       mais le coefficient derive est BAS de 5.4 a 5.7 pour cent et la modulation
  ...
  A-7  LA PERIODE DE LIBRATION D'UNE CELLULE PIEGEE VA COMME 1/eps. A 5|1.50|+1
       ...
       a plus ou moins 17, DANS ; C_P = 0.3262, 0.320, 0.3021, 0.2808 pour
       s0 = 0.15, 0.20, 0.25, 0.30 -- decroissant, pente ln P / ln eps = -1.071 sur
       quatre points : la periode depend de l'amplitude, comme un pendule hors
       de la petite oscillation ; lecture, non gelee. [MESURE-M2 ; predit m1]
...
nn.6 A ARBITRER PAR L'OPERATEUR, NON PRIS ICI
  (a) Trois regles de chantier proposees, sans regle nouvelle sous (X) :
      ...
      ecart plus fin que le pas n'est une mesure (A-6, A-7) ; (iii) toute loi
...
nn.10 PIECES DE CE DELTA (lot machine 1, canon = convention B du manifeste)
  journal_delta_nn_R4R5_v1.md                    cet acte
