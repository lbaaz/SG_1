JOURNAL DELTA nn -- LA SEQUENCE P-1 ENTRE AU REGISTRE : LE TEMPS D'ECHAPPEMENT
...
(redaction machine 1, depot operateur, 2026-09-02) -- PROJET, VERSION 3
=======================================================================
...
certification : DEUX HUNKS, en nn.2 A-3 et nn.2 A-5, et rien d'autre.
...
verifie_v2). NUMERO PRIS A L'ACTE au depot (N-68) : "nn" n'est pas un
numero. Aucun numero de serie (N, E, D) n'est pris ici : les files
...
nn.1 LA SEQUENCE ET SES PIECES (convention B, 16 hex ; ordre d'emission)
  ...
  02/09  lot m2 v2                   9284c14b4ca57352  le cusp : gels 0435cebc98d510a2,
         ...
         [recu par m1 seulement a la reemission, voir nn.8]
  ...
  02/09  lot m2 v4                   037ea9a9cde7449e  ordre total p = 11 : gel
         31010d29a32dd002 ; note 512d78c7cd263b24  [idem nn.8]
...
nn.2 LES FAITS ACQUIS (A-1 a A-7 de l'acte, avec les trois precisions de
  ...
  A-3  Le critere de recevabilite est pose sur l'AJUSTEMENT SEUL,
       ...
       deux residus nommes en nn.4. Dont DEUX PREDICTIONS AVEUGLES deposees par m1 sans les colonnes
...
nn.3 LE VERDICT DE 5.5 ET SA PORTEE EXACTE
...
nn.5 LES DEFAUTS CONSIGNES (etiquettes de chantier, plume m2 ; numeros
...
nn.6 PROPOSITIONS, A ARBITRER PAR L'OPERATEUR, NON PRISES ICI
  (a) Tout binaire porteur d'empreinte voyage DANS un ZIP ; les figures
      ...
      cotes, y compris ZIP imbrique (nn.8). Le seul depot binaire que
...
-- FIN journal_delta_nn_sequence_P1_v3 --
