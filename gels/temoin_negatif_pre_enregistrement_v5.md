...
Repond a   : note_machine1_certification_gel_temoin_v4.md 222883abcd47df9d
...
`comptes + sautes == 39` en forme derivee ; les lectures se comptent a
part et ne s'ajoutent pas aux runs.
...
-- FIN temoin_negatif_pre_enregistrement_v2 --
