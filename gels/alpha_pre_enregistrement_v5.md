# PRE-ENREGISTREMENT alpha v5 -- L'EXPOSANT DU PROFIL D'EXPLOSION EST-IL 4 u_p ?
# BROUILLON MACHINE 2 -- DEVIENT GEL A LA CERTIFICATION MACHINE 1

Fichier    : alpha_pre_enregistrement_v5.md
...
CE QUE LA v5 CHANGE PAR RAPPORT A LA v4 -- UNE LIGNE
             D-g-3 de note_machine1_certification_gels_v7_v4.md
             6b2425dbf906205b : la section 13 disait encore "il ne joue
             pas la branche sgn = -1", ce que la 4.4 de la v4 avait rendu
             faux a quatre points. Une entree fausse dans la liste de ce
             que le gel NE JOUE PAS est le defaut meme que 4.4 venait de
             fermer. La v4 (c261b6a5f34262e5) est NON CERTIFIEE et reste
             NON EDITEE (PB-1). Rien d'autre ne change.
...
-- FIN alpha_pre_enregistrement_v5 --
