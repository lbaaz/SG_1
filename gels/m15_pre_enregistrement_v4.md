...
(gele avant l'ecriture de toute ligne de code ; bloc ASCII hors PORTAGE v4 (extraits NFC verbatim de source), canonique NFC+LF ;
nom de fichier versionne, regle E19 -- version v4 HERITAGE, machine 1, 2026-08-09)
...
---------------------------------------------------------
  ...
  ASSIGNATION R-2' (D-6, definie en toutes lettres) : pour un
    ...
    petit. (Lecture argmin ; N-13 : la certification v2 de machine 2 appliquait la marge ABSOLUE -- meme mot, pas la meme regle ; ensemble F identique, six points d'assignation divergents)
...
LIMITATIONS DECLAREES
  ...
  - PAS-DE-STRUCTURE-RESOLUE n'est PAS une preuve : echappatoires
    ...
    a gauche, 7/300 a droite), moins profonde que le seuil -- CHIFFRE N-15 : marge 1.117 contre 1 sur le seul indice mesure, P(n_disc >= 1) = 0.399 sous q_L local, controle positif du gel a 1.025 ; voir PORTAGE P4.3 -- (COURBURES
