...
v7 -- LE TEXTE JOUE, CONTRESIGNE (A-1 de la cloture ; delta 77 fe4ea4a4).
v7 == copie de travail machine 2 (9c89a7a4fe43bc15) A L'EN-TETE PRES, un
seul hunk : le present bloc, qui corrige aussi l'ecart de releve ("deux"
pour TROIS blocs). Vs e804242b (machine 1) : TROIS blocs, tous ECRITURE,
zero MESURE -- (1) D-40 serialiseur certifie du pilote ; (2) test negatif
du serialiseur sur le bloc G6 reel du point fixe ; (3) D-41 ancres_XB par
pas_final(note du cote retenu), garde N-57. Audites ligne a ligne et
SIGNES (note machine 1 21c1432923ebf157). L'armement est REFERME ici.
=====================================================================
